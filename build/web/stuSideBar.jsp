        ...
        <div class="sidebar-user-material">
            <div class="sidebar-user-material-body">
                <div class="card-body text-center">
                    ...
                    %>
                    <h6 class="mb-0 text-white text-shadow-dark"><%= resultSet.getString("username") %></h6>
                    <%    }
                ...
                <!--<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Books</div> <i class="icon-menu" title="Layout options"></i></li>-->
                 <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Page layouts">
                        <li class="nav-item"><a href="requestBook.jsp" class="nav-link">Request a book</a></li>
                        <!--<li class="nav-item"><a href="#" class="nav-link">Return a book</a></li>-->
                    </ul>
                </li> 
                <!-- /layout -->
