                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=resultSet.getString("issuedays") %></td>
                                                        <td>
                                                            <form action="approveRequest" method="post">
                                                                <input type="hidden" name="id" value="<%= resultSet.getString("id") %>">
                                                                <input type="hidden" name="username" value="<%=resultSet.getString("username") %>">
                                                                <input type="hidden" name="usertype" value="<%=resultSet.getString("usertype") %>">
                                                                <input type="hidden" name="bookname" value="<%=resultSet.getString("bookname") %>">
                                                                ...
                                                                <input type="hidden" name="day" value="<%=resultSet.getString("issuedays") %>">
