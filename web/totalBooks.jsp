                                                ...
                                                <tbody>
                                                    <%
                                                        try{ 
                                                            ...
                                                            String sql ="SELECT  id,bookName,bookPrice,bookQuantity,bookAva,bookRent FROM book";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=resultSet.getString("bookQuantity") %></td>
                                                        <td><%=resultSet.getString("bookAva") %></td>
                                                        <td>
                                                            <form action="viewStudentBook.jsp" method="post">
                                                                <input type="hidden" name="bookId" value="<%=resultSet.getString("id") %>">
