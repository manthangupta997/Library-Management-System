				...
				<div class="card">
                                    ...
                                    <div class="card-body py-0 mb-4">
                                        ...
                                        <div class="container">
                                            ...
                                            <form class="needs-validation" action="oldBook" method="post" novalidate>
                                               ...
                                               <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control" placeholder="Book Available" name="bookAva" required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div id="validationServer01Feedback" class="invalid-feedback">
                                                                Please provide a valid book available.
                                                            </div>
                                                        </div>
            ...
            var status = document.getElementById("status").value;
                ...
                if(status == "success"){
                    Swal.fire({
                        icon: 'success',
                        title: 'Congrats!',
                        text: 'Old Book Added successfully'
                      });
                }
